...
<head>
    ...
    <meta charset="UTF-8">
    <meta name="description" content="la rose écarlate, article 2">  
...
<body>
    ...
    <nav class="header_nav">
        ...
        <main class="main">
    <img src="../assets/images/upload/bouquet_3x.jpg" alt="" width="400" height="400">
    <h3>"Lavande papillon"</h3>
     <u> Composition florale:</u>
     <ul>
        <li>Lavande papillon</li>
        <li>Clémentique</li>
        <li>Chardon</li>
