...
<head>
    ...
    <meta charset="UTF-8">
    <meta name="description" content="la rose écarlate, article 3">   
...
<body>
  ...
  <ul class="nav_menu">
    ...
    <main class="main">
   <img src="../assets/images/upload/bouquet_3.jpg" alt="" width="400" height="400">
   <h3>"Red Gemini"</h3>
    <u> Composition florale:</u>
     <ul>
        <li>Red Gemini</li>
        <li>Hipericum</li>
        <li>Oeillet Green Tick</li>

        <h4>Tarif: 34.00€</h4>
    </ul>
  <button><a href="../vue/contact.html">Acheter</a></button>
