...
<head>
    ...
    <meta charset="UTF-8">
    <meta name="description" content="la rose écarlate, article 1">   
...
<body>
  ...
  <ul class="nav_menu">
    ...
    <main class="main">
   <img src="../assets/images/upload/bouquet_1.jpg" alt="" width="400" height="400">
   <h3>"Roses du Cap d'Antibes"</h3>
   <u> Composition florale:</u>
   <ul>
      <li>Roses du "Cap d'Antibes"</li>
      <li>Ronocule</li>
      <li>Germini</li>
  </ul>
  <h4>Tarif: 32.00€</h4>
