...
<div class="col-md-3 text-end"><button class='btn btn-outline-primary me-2'>Login</button><button class='btn btn-primary'>Sign-up</button></div>
    ...
    <h1 class="h2 mb-4"><?=$produit->getProduit_nom()?></h1>
       <div class="d-flex flex-column flex-sm-row align-items-sm-center mb-4 ">
           ...
           <label class="col-sm-2 col-form-label " for="quantity">Quantité:</label>
           <div class="col-sm-3">
       ...
       <a href="../vue/contact.php"><button class="btn btn-primary me-5">Commander</button></a><span class="h4 mt-2"><?=$produit->getProduit_prix()?>€</span></form> </div>
