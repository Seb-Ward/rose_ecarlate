        ...
        <div class="container">
            <header class="py-4 d-flex flex-wrap align-items-center justify-content-center justify-content-md-between md-4 border-bottom">
                <a class="d-flex align-items-center col-md-3 mb-2 mb-md-0" href="../vue/equipe.php"><img width="230" height="70" src="../assets/images/logo_fcomme_fleurs.jpg" alt=""></a>
                        ...
                        <a class="col-md-8 text-end" href="../vue/connexion.php"><button class='btn btn-outline-primary'>Login</button></a><a href="../vue/form_inscription_client.php"><button class='btn btn-primary'>Logout</button></a>
  
            </header>
            <main>
        <div class="container">
                <h5> La boutique fut crée en aout 2010, un repère pour les antibois en quête de jolis bouquets et plantes.</h5>
    
                <!--Quick presentation of the team-->
                <div class="item1">
                    <ul>
                        <li><strong>Fréderic</strong><br>
                            <img src="../assets/images/upload/frederic_ristorto.jpg" class="rounded mx-auto d-block"  alt="Photo de Fréderic" width="310" height="250">
                        ...
                        <li><strong>Leatitia</strong><br>
                            <img src="../assets/images/upload/leatitia_f_comme_fleurs.jpg" class="rounded mx-auto d-block"  alt="" width="250" height="280">
